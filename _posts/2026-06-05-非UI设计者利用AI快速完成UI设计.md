...
**导入到Figma中的方式：**
1. 采用插件形式，在Figma内部使用 `Open html.to.design`插件可导入HTML源文件或者URL地址，利用插件生成figma源文件，但免费版每月只有10次导入机会
2. 采用 GoogleStitch 完成，在GoogleStich 中导入HTML源文件，并导入`Design.md`文件利用 AI 将HTML绘制出来，再导出为Figma源文件 
