...
这一章讲的是 **13. 参考资料**。学习 AI Agent 时最容易犯的错误，是把所有新名词都看成“更高级的聊天机器人功能”。更稳妥的学法是：先看它解决什么工程问题，再看它把模型、工具、上下文、状态、评测和安全中的哪一环变得更清楚。

### 一句话先懂

参考资料页的价值不是堆链接，而是告诉你遇到不同问题时优先查哪类一手资料。

### 通俗类比

参考资料像工具间的标签柜：官方文档用于查规范，工程博客用于看经验，社区文章用于找坑，论文用于理解思想来源。把所有资料混放，会降低学习效率。
...
把资料按“官方规范、框架文档、工程实践、安全评测、社区案例”分类，并为每类写出适合解决的问题。
...
能根据问题类型选择资料来源；能区分事实、经验、观点和过时内容；能给自己的笔记保留可追溯引用。
