...
## 讲义级补充：如何真正学懂《14. 生产级 AI Agent 工程补充》

> 适用位置：AI-Agent学习笔记\14-生产级AI-Agent.md  
...
学习《14. 生产级 AI Agent 工程补充》时，先做一个最小可验证例子：输入要小，步骤要清楚，输出要能检查。然后故意制造一个错误，观察系统如何失败，并记录排查顺序。
