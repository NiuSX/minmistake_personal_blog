...
## 讲义级补充：如何真正学懂《Android 学习笔记总目录》

> 适用位置：Android学习笔记\00-README.md  
...
学习《Android 学习笔记总目录》时，可以做一个只有列表、详情、加载失败和重试的小页面。把状态从数据层传到 ViewModel，再传到 UI，最后旋转屏幕或切后台回来检查状态是否稳定。
