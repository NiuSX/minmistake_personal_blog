...
版本说明：截至 2026-06-07，Docker 官方文档以 Docker Desktop、Docker Engine、Docker Compose、Docker Build、Dockerfile Reference、Compose Specification 等文档为准。Docker 版本、Compose 插件版本、BuildKit/Buildx 能力更新较快，具体命令参数请以 `docker --help`、`docker compose --help` 和 Docker 官方文档为准。现代 Docker 推荐使用 `docker compose` 子命令，而不是旧的独立 `docker-compose` 命令。
