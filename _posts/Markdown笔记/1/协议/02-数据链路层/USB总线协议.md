...
这一章讲的是 **USB 总线协议学习笔记**，属于 **数据链路层协议**。学习协议时，不要只背“它是什么协议、默认端口是多少”，而要把它当成一份双方共同遵守的通信合同：谁先说话，说什么格式，字段怎么解释，什么时候确认，什么时候重传，出错时返回什么，版本升级时怎样保持兼容。
...
### 精讲扩展 1：USB总线协议 的分层模型、帧格式 与工程化理解
...
### 精讲扩展 2：USB总线协议 的帧格式、握手流程 与工程化理解
