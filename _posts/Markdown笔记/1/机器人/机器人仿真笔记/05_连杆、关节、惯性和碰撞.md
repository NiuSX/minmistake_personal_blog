...
- URDF XML inertial 文档：[https://wiki.ros.org/urdf/XML/link](https://wiki.ros.org/urdf/XML/link)
- SDFormat collision 规范：[https://sdformat.org/spec](https://sdformat.org/spec)
