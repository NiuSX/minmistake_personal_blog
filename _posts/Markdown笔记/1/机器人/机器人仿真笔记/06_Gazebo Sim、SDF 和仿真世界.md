...
## 讲义级补充：如何真正学懂《06 Gazebo Sim、SDF 和仿真世界》

> 适用位置：机器人\机器人仿真笔记\06_Gazebo Sim、SDF 和仿真世界.md  
...
学习《06 Gazebo Sim、SDF 和仿真世界》时，可以选一个最小机器人场景：给定起点、目标点和传感器输入，画出坐标变换、状态估计、规划路径和控制输出。每一步都标注单位和时间戳，很多问题会立刻暴露。
