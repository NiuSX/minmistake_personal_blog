...
## 讲义级补充：如何真正学懂《40 PCB 与硬件设计术语表》

> 适用位置：硬件PCB学习\40_PCB与硬件设计术语.md  
...
学习《40 PCB 与硬件设计术语表》时，可以围绕一个简单电源或传感器板卡展开：先读数据手册，再画原理图，接着标出电流路径和信号路径，最后列出上电前检查表。这个过程比单独背概念更接近真实设计。
