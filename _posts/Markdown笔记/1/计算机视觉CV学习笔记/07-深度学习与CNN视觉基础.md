...
## 讲义级补充：如何真正学懂《07-深度学习与 CNN 视觉基础》

> 适用位置：计算机视觉CV学习笔记\07-深度学习与CNN视觉基础.md  
...
学习《07-深度学习与 CNN 视觉基础》时，可以准备一个很小的数据集，先手工看 20 个样本和标签，再训练一个基线模型，最后把预测错误的样本逐张分析。很多模型问题不是公式错了，而是数据、标注或评价方式一开始就没有定义清楚。
